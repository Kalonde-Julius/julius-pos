...
var require_parse = __commonJS({
  "node_modules/qs/lib/parse.js"(exports2, module2) {
    ...
    var splitKeyIntoSegments = function splitKeyIntoSegments2(originalKey, options) {
      ...
      var parent2 = first >= 0 ? key.slice(0, first) : key;
      if (parent2) {
...
function useForm(...args) {
  ...
  const commitData = (0, import_react9.useCallback)(
    (next) => {
  ...
  const submit = (0, import_react9.useCallback)(
    (...args2) => {
      ...
      const transformedData = transform2.current(dataRef.current);
      if (method2 === "delete") {
...
var Head = function({ children, title }) {
  ...
  function renderNodes(nodes) {
    ...
    if (title && !elements.find((tag) => tag.startsWith("<title"))) {
      elements.push(`<title ${provider.preferredAttribute()}>${escape_default(title)}</title>`);
    }
    return elements;
  }
  if (isServer3) {
...
var InfiniteScroll = (0, import_react12.forwardRef)(
  ({
    ...
    const [hasPreviousPage, setHasPreviousPage] = (0, import_react12.useState)(!!scrollProp?.previousPage);
    const [hasNextPage, setHasNextPage] = (0, import_react12.useState)(!!scrollProp?.nextPage);
...
function usePoll(interval, requestOptions = {}, options = {
  ...
  const latest = (0, import_react14.useRef)(requestOptions);
  latest.current = requestOptions;
  const pollRef = (0, import_react14.useRef)(null);
